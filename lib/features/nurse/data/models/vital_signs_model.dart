...
class VitalSignsModel extends Equatable {
  ...
  String get respiratoryRateText {
    return '$respiratoryRate breaths/min';
  }
  ...
  bool get isValid {
    return bloodPressureSystolic > 0 &&
        bloodPressureDiastolic > 0 &&
        heartRate > 0 &&
        temperature > 0 &&
        respiratoryRate > 0 &&
  ...
  factory VitalSignsModel.fromJson(Map<String, dynamic> json) {
    return VitalSignsModel(
      ...
      heartRate: _toInt(
        json['heartRate'] ?? json['heart_rate'],
      ),
      temperature: _toDouble(
        json['temperature'],
      ),
      respiratoryRate: _toInt(
        json['respiratoryRate'] ?? json['respiratory_rate'],
      ),
      oxygenSaturation: _toDouble(
        json['oxygenSaturation'] ?? json['oxygen_saturation'],
      ),
      recordedAt: _toDateTime(
